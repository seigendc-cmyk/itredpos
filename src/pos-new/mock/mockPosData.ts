...
export const mockCOGSReserveRows: COGSReserveRowRecord[] = [
...
export const mockInventoryAccountingReadinessRecords: InventoryAccountingReadinessRecord[] = [
  { readinessId: 'IAR-ID-0001', readinessNumber: 'IAR-0001', vendorId: 'SCI-LOG-ZW', sourceType: 'GRN', sourceId: 'GRN-ID-0003', sourceNumber: 'GRN-0003', movementId: 'MOV-GRN-0003', movementType: 'GOODS_RECEIVED', impactType: 'Inventory Asset Increase', branchId: 'BR-HARARE', branchName: 'Harare Main', warehouseId: 'WH-HARARE-01', warehouseName: 'Harare Main Warehouse', status: 'Pending Review', riskLevel: 'Low', totalValueImpact: 248, currency: 'USD', recommendedAction: 'Review GRN posting and confirm supplier invoice before releasing to stock.', notes: 'Posted GRN can create inventory asset increase pending review. No supplier payment posted.', createdAt: '2026-06-12T08:10:00Z', updatedAt: '2026-06-12T08:10:00Z' },
  { readinessId: 'IAR-ID-0002', readinessNumber: 'IAR-0002', vendorId: 'SCI-LOG-ZW', sourceType: 'Supplier Return', sourceId: 'SRT-ID-0003', sourceNumber: 'SRT-0003', movementId: 'MOV-SRT-0003', movementType: 'SUPPLIER_RETURN', impactType: 'Inventory Asset Decrease', branchId: 'BR-HARARE', branchName: 'Harare Main', warehouseId: 'WH-RET-01', warehouseName: 'Return Holding', status: 'Pending Review', riskLevel: 'Medium', totalValueImpact: -72, currency: 'USD', recommendedAction: 'Confirm supplier credit note receipt before closing inventory decrease.', notes: 'Supplier credit expected placeholder only.', createdAt: '2026-06-12T08:20:00Z', updatedAt: '2026-06-12T08:20:00Z' },
  { readinessId: 'IAR-ID-0003', readinessNumber: 'IAR-0003', vendorId: 'SCI-LOG-ZW', sourceType: 'Stock Adjustment', sourceId: 'STA-ID-0002', sourceNumber: 'STA-0002', movementId: 'MOV-STA-0002', movementType: 'WRITE_OFF', impactType: 'Inventory Write Off', branchId: 'BR-HARARE', branchName: 'Harare Main', warehouseId: 'WH-DMG-01', warehouseName: 'Damaged Holding', status: 'On Hold', riskLevel: 'High', totalValueImpact: -180, currency: 'USD', recommendedAction: 'Manager approval required before write-off can post to accounting.', notes: 'Write-off review on hold pending manager notes.', createdAt: '2026-06-12T08:30:00Z', updatedAt: '2026-06-12T08:30:00Z' },
  { readinessId: 'IAR-ID-0004', readinessNumber: 'IAR-0004', vendorId: 'SCI-LOG-ZW', sourceType: 'Stocktake', sourceId: 'STK-ID-0004', sourceNumber: 'STK-0004', movementId: 'MOV-STK-0004', movementType: 'STOCKTAKE_LOSS', impactType: 'Stocktake Loss', branchId: 'BR-BYO', branchName: 'Bulawayo Branch', warehouseId: 'WH-BYO-01', warehouseName: 'Bulawayo Branch Warehouse', status: 'Pending Review', riskLevel: 'Critical', totalValueImpact: -360, currency: 'USD', recommendedAction: 'Investigate stocktake loss cause and obtain manager approval before posting.', notes: 'Critical stocktake loss requires accounting approval placeholder.', createdAt: '2026-06-12T08:40:00Z', updatedAt: '2026-06-12T08:40:00Z' },
  { readinessId: 'IAR-ID-0005', readinessNumber: 'IAR-0005', vendorId: 'SCI-LOG-ZW', sourceType: 'Stock Transfer', sourceId: 'TRF-ID-0002', sourceNumber: 'TRF-0002', movementId: 'MOV-TRF-0002', movementType: 'BRANCH_TRANSFER_OUT', impactType: 'Transfer Neutral', branchId: 'BR-HARARE', branchName: 'Harare Main', warehouseId: 'WH-HARARE-01', warehouseName: 'Harare Main Warehouse', status: 'Reviewed', riskLevel: 'Low', totalValueImpact: 0, currency: 'USD', reviewedByStaffId: 'ST-ADMIN', reviewedByStaffName: 'Admin User', recommendedAction: 'No action required. Transfer neutral under current policy.', notes: 'Transfer neutral under current policy.', createdAt: '2026-06-12T08:50:00Z', updatedAt: '2026-06-12T09:10:00Z' }
];
