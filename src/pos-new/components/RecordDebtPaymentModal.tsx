    ...
    <div className="pos-modal-backdrop" role="presentation">
      <section className="pos-record-debt-modal" role="dialog" aria-modal="true" aria-labelledby="record-debt-payment-title">
        ...
        <div className="pos-record-debt-form">
          ...
          <label>Payment Method<select value={paymentMethod} onChange={(event) => setPaymentMethod(event.target.value)}><option>Cash</option><option>EcoCash</option><option>Innbucks</option><option>Mukuru</option><option>ZIPIT</option><option>Bank Transfer</option><option>Card</option></select></label>
