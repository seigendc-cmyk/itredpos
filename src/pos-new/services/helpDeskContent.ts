...
const menuArticles: HelpArticle[] = [
  ...
  menuArticle('menu-inventory', 'How to use Inventory', 'stock-inventory-import', 'STOCK', 'Inventory manages product master data, stock balances, imports, movements, stock adjustments, stocktake, purchase receiving, transfers, and reports.', ['Product List', 'Product Master', 'Product Import', 'Stock Adjustments', 'Stocktake'], ['products', 'stock balances', 'imports', 'stock movements'], ['Do not import products without checking required columns.', 'Do not post stock corrections without reason and approval where required.'], ['inventory', 'stock', 'import', 'stocktake']),
...
const actionArticles: HelpArticle[] = [
  ...
  actionArticle('action-import-products', 'Import Products', 'stock-inventory-import', 'STOCK', 'Import Products', 'Opens Product Import for bulk product CSV setup.', ['import products', 'csv import'], 'Product Import'),
...
const narrativeArticles: HelpArticle[] = [
  ...
  narrativeArticle('routine-inventory-import', 'How to Avoid Bad Inventory Imports', 'stock-inventory-import', 'A good import protects product master quality by checking columns, validating rows, and reviewing duplicate risk before posting.', ['Paste or select data.', 'Check required columns.', 'Validate warnings and errors.', 'Fix duplicate or missing-cost rows.', 'Post only ready rows.'], ['Do not import unknown products with no cost.', 'Do not import quantity columns casually.'], ['inventory import', 'bad import'], [link('Open Product Import', 'STOCK', 'Open Product Import.', 'Product Import')]),
