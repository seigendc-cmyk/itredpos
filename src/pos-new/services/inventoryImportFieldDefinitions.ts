...
export const inventoryImportFieldDefinitions: InventoryImportFieldDefinition[] = [
  ...
  field('openingQuantity', 'Opening Quantity', 'Required', true, 'Quantity', 'Stock', ['Qty 1', 'On Hand', 'O/H Qty', 'Quantity', 'Stock Qty', 'Qty', 'openingQuantity'], '4', 'Opening stock quantity preview.'),
  field('unitCost', 'Unit Cost', 'Recommended', false, 'Money', 'Pricing', ['Average Unit Cost', 'Cost', 'Buy Price', 'Purchase Price', 'Cost Price', 'unitCost'], '16.00', 'Default cost used for stock value.'),
  ...
  field('shelf', 'Shelf / Bin', 'Recommended', false, 'Text', 'Location', ['Attribute', 'Shelf', 'Location', 'Bin', 'Bin Location', 'shelfLocation'], 'A1-S4', 'Shelf or bin location.'),
